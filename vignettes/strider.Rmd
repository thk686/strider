...
The **strided_pointer** and related functions are designed to be used in C++ code. I first create a header to avoid some repetitive code declarations.
...
```{Rcpp}
// [[Rcpp::depends(BH)]]           /* only needed for Travis CI */
